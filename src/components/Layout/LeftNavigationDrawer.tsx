                ...
                <List>
                    <ListItem key={'Home'} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton sx={[{ minHeight: 48, px: 2.5 }, open ? { justifyContent: 'initial', } : { justifyContent: 'center' }]} onClick={() => { }}>
                            ...
                            >
                                <Icon baseClassName="fas" className="fa-home" sx={{ fontSize: 18, width: 50 }} />
                            </ListItemIcon>
                            <ListItemText
                                primary={'Home'}
                    ...
                    <ListItem key={'Dashboard'} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton sx={[{ minHeight: 48, px: 2.5 }, open ? { justifyContent: 'initial', } : { justifyContent: 'center' }]} onClick={() => { }}>
                            <ListItemIcon
                                sx={[{ minWidth: 0, justifyContent: 'center' }, open ? { mr: 3, } : { mr: 'auto', }]}
                            >
                                <Icon baseClassName="fas" className="fa-dashboard" sx={{ fontSize: 18, width: 50 }} />
                            </ListItemIcon>
                            <ListItemText
                                primary={'Dashboard'}
                                sx={[open ? { opacity: 1, } : { opacity: 0, }]}
                    ...
                    <ListItem key={'Applicants'} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton sx={[{ minHeight: 48, px: 2.5 }, open ? { justifyContent: 'initial', } : { justifyContent: 'center' }]} onClick={() => { window.location.href = '/applicant' }}>
                            <ListItemIcon
                                sx={[{ minWidth: 0, justifyContent: 'center' }, open ? { mr: 3, } : { mr: 'auto', }]}
                            >
                    ...
                    <ListItem key={'Settings'} disablePadding sx={{ display: 'block' }}>
                        <ListItemButton sx={[{ minHeight: 48, px: 2.5 }, open ? { justifyContent: 'initial', } : { justifyContent: 'center' }]} onClick={() => { }}>
                            <ListItemIcon
                                sx={[{ minWidth: 0, justifyContent: 'center' }, open ? { mr: 3, } : { mr: 'auto', }]}
                            >
                                <Icon baseClassName="fas" className="fa-cog" sx={{ fontSize: 18, width: 50 }} />
                            </ListItemIcon>
                            <ListItemText
                                primary={'Settings'}
                                sx={[open ? { opacity: 1, } : { opacity: 0, }]}
